/**
 * Manjaku script glyphs — inner SVG path data extracted from authoritative
 * Notion source files. viewBox is always "0 0 1000 1000".
 * stroke="currentColor" means colour is set via the color CSS property.
 */
export const MANJAKU_GLYPHS: Record<string, string> = {
  ...
  letter_E_acute: `<g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"><path d="M500 300 C380 300 380 520 500 520 C620 520 620 740 500 740"/><path d="M500 300 C620 300 620 520 500 520"/></g><circle cx="650" cy="240" r="40" fill="white"/><g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"></g>`,
  ...
  letter_HEU: `<g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"></g><circle cx="500" cy="360" r="140" fill="none" stroke="currentColor" stroke-width="60"/><g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"><path d="M500 500 L500 800"/><path d="M380 560 L620 560"/></g>`,
  ...
  letter_L: `<g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"></g><circle cx="500" cy="540" r="240" fill="none" stroke="currentColor" stroke-width="60"/><g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"><path d="M340 700 L660 380"/></g>`,
  ...
  letter_GNE: `<g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"></g><circle cx="420" cy="520" r="120" fill="none" stroke="currentColor" stroke-width="60"/><g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"><path d="M520 580 L660 760"/></g>`,
  ...
  letter_NGHE: `<g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"></g><circle cx="500" cy="360" r="140" fill="none" stroke="currentColor" stroke-width="60"/><g fill="none" stroke="currentColor" stroke-width="60" stroke-linecap="round" stroke-linejoin="round"><path d="M500 500 L500 800"/><path d="M360 560 L620 560"/><path d="M320 720 L680 880"/></g>`,
